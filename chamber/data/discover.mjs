export const discoverItems = [
    {
        ...
        address: "Regent-Sierra Leone, Freetown",
        description: "A sanctuary nestled in the rainforest reserve protecting rescued and orphaned chimpanzees.",
        photo: "images/tacugama.webp"
    },
    {
        title: "Lumley Beach",
        address: "Lumley Beach Road, Freetown",
        description: "A vibrant stretch of sandy coastline known for its lively restaurants, evening walks, and Atlantic views.",
    ...
    {
        title: "Cotton Tree",
        address: "Center of Downtown Freetown",
        description: "An iconic historic symbol and landmark representing freedom and the capital's deep historical roots.",
